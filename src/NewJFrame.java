...
public class NewJFrame extends javax.swing.JFrame {
    ...
    int turn=2;
    //to stop to over writing of the value on the button
    ...
    int p1won()
    {
        if(p1won[0]==1&& p1won[1]==1 && p1won[2]==1)  //it means that first line has 3x
        {
            return 1;
    }
    {
   ...
   return 0;
    ...
    int p2won()
    {
        if(p2won[0]==1&& p2won[1]==1 && p2won[2]==1)  //it means that first line has 3x
        {
            return 1;
    }
    {
   ...
   return 0;
    ...
    private void b6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b6ActionPerformed
      ...
      if(buttonused[5]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
        {
            turn++;
            b6.setText("x");
            buttonused[5]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[5]=1;
    ...
    else
     {
          ...
          JOptionPane.showMessageDialog(rootPane,"Alert, This Button is Already used!..");  
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here: if(turn%2==0)
     if(buttonused[3]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
        {
            turn++;
            b4.setText("x");
            buttonused[3]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[3]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b5ActionPerformed
        // TODO add your handling code here:
     if(buttonused[4]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
        {
            turn++;
            b5.setText("x");
            buttonused[4]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[4]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b9ActionPerformed
        // TODO add your handling code here:
    if(buttonused[8]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
        {
            turn++;
            b9.setText("x");
            buttonused[8]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[8]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b8ActionPerformed
        // TODO add your handling code here:
      if(buttonused[7]==0)  // only if buttonused is 0 it will work
      {
          if(turn%2==0)
        {
            turn++;
            b8.setText("x");
            buttonused[7]=1; //when ever the button is used 1 will be added to the array add 
            p1won[7]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        // TODO add your handling code here:
      if(buttonused[0]==0)  // only if buttonused is 0 it will work
      {
          if(turn%2==0)
        {
            turn++;
            b1.setText("x");
            buttonused[0]=1; //when ever the button is used 1 will be added to the array add 
            p1won[0]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b7ActionPerformed
        // TODO add your handling code here:
      if(buttonused[6]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
        {
            turn++;
            b7.setText("x");
            buttonused[6]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[6]=1;
            int result1= p1won();
            int result2= p2won();
    ...
    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
        // TODO add your handling code here:
        if(buttonused[1]==0)  // only if buttonused is 0 it will work
        {
             if(turn%2==0)
            {
               turn++;
               b2.setText("x");
               buttonused[1]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
               p1won[1]=1;
               int result1= p1won();
            int result2= p2won();
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed
        // TODO add your handling code here:
      if(buttonused[2]==0)  // only if buttonused is 0 it will work
    {
          if(turn%2==0)
          {
            turn++;
            b3.setText("x");
            buttonused[2]=1; //when ever the button is used 1 will be added to the array add thus it cant be used again
            p1won[1]=1;
            int result1= p1won();
            int result2= p2won();
